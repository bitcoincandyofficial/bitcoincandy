...
static const char UNUSED *bitcoin_strings[] = {
    QT_TRANSLATE_NOOP("bitcoin-candy", "Bitcoin CDY"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "The %s developers"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      ""
    ...
    QT_TRANSLATE_NOOP("bitcoin-candy", "%s corrupt, salvage failed"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "%s is set very high!"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "(default: %s)"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "(default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "-maxmempool must be at least %d MB"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "<category> can be:"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
    ...
    QT_TRANSLATE_NOOP("bitcoin-candy", "Append comment to the user agent string"),
    QT_TRANSLATE_NOOP(
        "bitcoin-candy",
        "Attempt to recover private keys from a corrupt wallet on startup"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Automatically create Tor hidden service (default: %d)"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Block creation options:"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Cannot downgrade wallet"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Cannot resolve -%s address: '%s'"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Cannot write default address"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Chain selection options:"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Change index out of range"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Connect through SOCKS5 proxy"),
    QT_TRANSLATE_NOOP(
        "bitcoin-candy",
        "Connect to a node to retrieve peer addresses, and disconnect"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Connection options:"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Copyright (C) %i-%i"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Corrupted block database detected"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Debugging/Testing options:"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Do not load the wallet and disable wallet RPC calls"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Do you want to rebuild the block database now?"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Done loading"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Enable publish hash block in <address>"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Enable publish hash transaction in <address>"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Enable publish raw block in <address>"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Enable publish raw transaction in <address>"),
    QT_TRANSLATE_NOOP(
        "bitcoin-candy",
        "Enable transaction replacement in the memory pool (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Error initializing block database"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Error initializing wallet database environment %s!"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Error loading %s"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Error loading %s: Wallet corrupted"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Error loading %s: Wallet requires newer version of %s"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Error loading %s: You can't disable HD "
                                     "on a already existing HD wallet"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Error loading block database"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Error opening block database"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Error reading from database, shutting down."),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Error"),
    QT_TRANSLATE_NOOP(
        "bitcoin-candy",
        "Error: A fatal internal error occurred, see debug.log for details"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Error: Disk space is low!"),
    QT_TRANSLATE_NOOP(
        "bitcoin-candy",
    ...
    QT_TRANSLATE_NOOP("bitcoin-candy", "Importing..."),
    QT_TRANSLATE_NOOP(
        "bitcoin-candy",
    ...
    QT_TRANSLATE_NOOP("bitcoin-candy", "Information"),
    QT_TRANSLATE_NOOP(
        "bitcoin-candy",
        "Initialization sanity check failed. %s is shutting down."),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Insufficient funds"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Invalid -onion address: '%s'"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Invalid -proxy address: '%s'"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Invalid amount for -%s=<amount>: '%s'"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
    ...
    QT_TRANSLATE_NOOP("bitcoin-candy", "Listen for JSON-RPC connections on "
                                     "<port> (default: %u or testnet: %u)"),
    QT_TRANSLATE_NOOP(
        "bitcoin-candy",
        "Listen for connections on <port> (default: %u or testnet: %u)"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Loading addresses..."),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Loading banlist..."),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Loading block index..."),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Loading wallet..."),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Location of the auth cookie (default: data dir)"),
    QT_TRANSLATE_NOOP(
        "bitcoin-candy",
        "Maintain at most <n> connections to peers (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Make the wallet broadcast transactions"),
    QT_TRANSLATE_NOOP(
        "bitcoin-candy",
    ...
    QT_TRANSLATE_NOOP("bitcoin-candy", "Node relay options:"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Not enough file descriptors available."),
    QT_TRANSLATE_NOOP(
        "bitcoin-candy",
        "Only connect to nodes in network <net> (ipv4, ipv6 or onion)"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Options:"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Password for JSON-RPC connections"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Prepend debug output with timestamp (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Print this help message and exit"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Print version and exit"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Prune cannot be configured with a negative value."),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Prune mode is incompatible with -txindex."),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Pruning blockstore..."),
    QT_TRANSLATE_NOOP("bitcoin-candy", "RPC server options:"),
    QT_TRANSLATE_NOOP(
        "bitcoin-candy",
        "Rebuild chain state and block index from the blk*.dat files on disk"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Rebuild chain state from the currently indexed blocks"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Reducing -maxconnections from %d to %d, "
                                     "because of system limitations."),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Relay and mine data carrier transactions (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Relay non-P2SH multisig (default: %u)"),
    QT_TRANSLATE_NOOP(
        "bitcoin-candy",
        "Rescan the block chain for missing wallet transactions on startup"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Rescanning..."),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Rewinding blocks..."),
    QT_TRANSLATE_NOOP("bitcoin-candy",
    ...
    QT_TRANSLATE_NOOP("bitcoin-candy", "Set key pool size to <n> (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
    ...
    QT_TRANSLATE_NOOP("bitcoin-candy", "Signing transaction failed"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Specify configuration file (default: %s)"),
    QT_TRANSLATE_NOOP(
        "bitcoin-candy",
        "Specify connection timeout in milliseconds (minimum: 1, default: %d)"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Specify data directory"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Specify pid file (default: %s)"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Specify wallet file (within data directory)"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Specify your own public address"),
    QT_TRANSLATE_NOOP(
        "bitcoin-candy",
        "Spend unconfirmed change when sending transactions (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Starting network threads..."),
    QT_TRANSLATE_NOOP("bitcoin-candy", "The source code is available from %s."),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "The transaction amount is too small to pay the fee"),
    QT_TRANSLATE_NOOP(
        "bitcoin-candy",
        "The wallet will avoid paying less than the minimum relay fee."),
    QT_TRANSLATE_NOOP("bitcoin-candy", "This is experimental software."),
    QT_TRANSLATE_NOOP(
        "bitcoin-candy",
    ...
    QT_TRANSLATE_NOOP("bitcoin-candy", "Transaction amount too small"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
    ...
    QT_TRANSLATE_NOOP("bitcoin-candy", "Transaction too large for fee policy"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Transaction too large"),
    QT_TRANSLATE_NOOP(
        "bitcoin-candy",
        "Unable to bind to %s on this computer (bind returned error %s)"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Unable to bind to %s on this computer. "
    ...
    QT_TRANSLATE_NOOP("bitcoin-candy", "Use the test chain"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "User Agent comment (%s) contains unsafe characters."),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Username for JSON-RPC connections"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Verifying blocks..."),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Verifying wallet..."),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Wallet %s resides outside data directory %s"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Wallet debugging/testing options:"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Wallet needed to be rewritten: restart %s to complete"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Wallet options:"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Warning"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Warning: unknown new rules activated (versionbit %i)"),
    QT_TRANSLATE_NOOP("bitcoin-candy",
                      "Whether to operate in a blocks only mode (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin-candy", "Zapping all transactions from wallet..."),
    QT_TRANSLATE_NOOP("bitcoin-candy", "ZeroMQ notification options:"),
};
